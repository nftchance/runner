...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'ordering': ['created_at'],
                'permissions': (('manage_org', 'Can manage organization'), ('manage_orgrole', 'Can manage organization roles of other users'), ('manage_orginvitation', 'Can manage organization invitations')),
            },
        ),
        migrations.CreateModel(
            name='OrgInvitation',
